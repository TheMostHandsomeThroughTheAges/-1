...
- 4联通：对于具有值$$V$$的像素$$p$$和$$q$$，如果$$q$$在集合$$N_4(p)$$中，则称这两个像素是4连通。
...
1. **腐蚀**
    ...
    具体操作是：用一个结构元素扫描图像中的每一个像素，用结构元素中的每一个像素与其覆盖的像素做“与”操作，如果都为1，则该像素为1，否则为0。如下图所示，结构A被结构B腐蚀后：![image-20190927105316401](assets/image-20190927105316401.png)
...
###### ![image-20190927110711458](assets/image-20190927110711458.png)膨胀的作用是将与物体接触的所有背景点合并到物体中，使目标增大，可添补目标中的孔洞。
...
3. **API**
   ...
   - op: 处理方式：
     ...
     ![image-20191016162318033](assets/image-20191016162318033.png)
